...
%             data = filtfilt(b,a,data);
        ...
        chan_fname = [foc_nm '_' pt_nm '_' chnl_lbl{kk} '_' EEG.info.ref '.mat']; % File name for each electrode
