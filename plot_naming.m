function ax = plot_naming(dat_files, gsize, resp, pth, study, fs, lock)

    plt_pth = [pth 'Channel Plots by Position in Category/' study '/Group Size ' gsize '/'];
    ...
    for ii = 1:length(dat_files)
        ...
        X(:,ii) = plot(st_tm:1000/fs:en_tm, dat, 'color', c, 'Linewidth', 2, 'DisplayName', ['Pos. in Cat.: ' cat_no]);
